---
description: Enter the Harness workflow and decide the next action from the current repository workflow state
argument-hint: "[instruction]"
---

This command maps to `harness`.
...
- center the task around `harness`
