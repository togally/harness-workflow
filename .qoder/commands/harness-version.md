---
description: Run harness version and continue work inside the current Harness workflow state
argument-hint: "<name>"
---

This command maps to `harness version`.
...
- center the task around `harness version`
