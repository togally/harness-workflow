---
description: Run harness exit and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness exit`.
...
- center the task around `harness exit`
