---
description: Run harness status and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness status`.
...
- center the task around `harness status`
