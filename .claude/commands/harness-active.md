---
description: Run harness active and continue work inside the current Harness workflow state
argument-hint: "<version>"
---

This command maps to `harness active`.
...
- center the task around `harness active`
