---
description: Run harness install and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness install`.
...
- center the task around `harness install`
