---
description: Run harness rename and continue work inside the current Harness workflow state
argument-hint: "<kind> <old> <new>"
---

This command maps to `harness rename`.
...
- center the task around `harness rename`
