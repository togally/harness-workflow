---
description: Run harness feedback and continue work inside the current Harness workflow state
argument-hint: "[--reset]"
---

This command maps to `harness feedback`.
...
- center the task around `harness feedback`
