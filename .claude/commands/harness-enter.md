---
description: Run harness enter and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness enter`.
...
- center the task around `harness enter`
