---
description: Run harness init and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness init`.
...
- center the task around `harness init`
