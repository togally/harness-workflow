---
description: Run harness regression and continue work inside the current Harness workflow state
argument-hint: "<issue>|--confirm|--change <title>"
---

This command maps to `harness regression`.
...
- center the task around `harness regression`
