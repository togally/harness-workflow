---
description: Run harness plan and continue work inside the current Harness workflow state
argument-hint: "<change>"
---

This command maps to `harness plan`.
...
- center the task around `harness plan`
