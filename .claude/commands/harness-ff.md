---
description: Run harness ff and continue work inside the current Harness workflow state
argument-hint: ""
---

This command maps to `harness ff`.
...
- center the task around `harness ff`
