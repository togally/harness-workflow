---
description: Run harness archive and continue work inside the current Harness workflow state
argument-hint: "<requirement>"
---

This command maps to `harness archive`.
...
- center the task around `harness archive`
