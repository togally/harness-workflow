...
1. Create `docs/` as the new canonical entrypoint
2. Add indexes and workflow entry files under `docs/`
3. Reference legacy `doc/` locations from `docs/README.md`
...
- Existing ADRs can remain where they are if `docs/README.md` links them
- Existing plans can remain if there is a clear active/archive distinction
- Existing architecture docs can be referenced from `docs/context/project/` indexes
