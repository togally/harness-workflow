...
- 创建了 `.workflow/context/roles/tools-manager.md`，包含完整角色定义、SOP、匹配算法、返回值格式
- 修改了 `base-role.md`，将 toolsManager 详细行为迁移到独立角色文件，base-role 保留硬门禁引用
- 为所有 stage 角色（requirement-review、planning、executing、testing、acceptance、regression、done）增加了标准工作流程（SOP）章节
- 更新了 `.workflow/context/index.md`，补充了辅助角色说明
- 测试验证通过：20 passed, 36 skipped
