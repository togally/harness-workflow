...
priority: medium
linked_regression: reg-02
partial_promoted_to_chg: chg-02
partial_archived_at: 2026-04-28
partial_archive_note: "over-chain 副作用部分 archived（chg-02 fix 部署同步契约修复 over-chain）；sug-39（派发钩子未接通）主因部分保留 pending"
---
