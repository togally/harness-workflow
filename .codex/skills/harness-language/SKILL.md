...
description: "Use when the user wants `harness language` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Language

This is a thin wrapper skill for `harness language`.
...
- treat `harness language` as the primary action
