---
name: harness-update
description: "Use when the user wants `harness update` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Update

This is a thin wrapper skill for `harness update`.
...
- treat `harness update` as the primary action
