...
description: "Use when the user wants `harness version` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Version

This is a thin wrapper skill for `harness version`.
...
- treat `harness version` as the primary action
