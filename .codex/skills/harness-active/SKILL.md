---
name: harness-active
description: "Use when the user wants `harness active` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Active

This is a thin wrapper skill for `harness active`.
...
- treat `harness active` as the primary action
