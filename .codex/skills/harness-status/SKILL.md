---
name: harness-status
description: "Use when the user wants `harness status` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Status

This is a thin wrapper skill for `harness status`.
...
- treat `harness status` as the primary action
