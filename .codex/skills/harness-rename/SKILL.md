---
name: harness-rename
description: "Use when the user wants `harness rename` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Rename

This is a thin wrapper skill for `harness rename`.
...
- treat `harness rename` as the primary action
