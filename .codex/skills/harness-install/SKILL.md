...
description: "Use when the user wants `harness install` or equivalent intent. Read workflow state first, then route into the main harness skill."
---

# Harness Install

This is a thin wrapper skill for `harness install`.
...
- treat `harness install` as the primary action
