...
1. Read `docs/memory/constitution.md` before analysis or design work
2. Read `docs/context/experience/index.md` before analysis, design, implementation, or self-check
3. Load only matching experience files instead of the full experience tree
4. Use `docs/context/rules/agent-workflow.md` for the detailed workflow
