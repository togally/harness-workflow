...
> req-id: req-01 | 完成时间: 2026-04-14 | 分支: main
...
- **chg-03** chg-03-三端支持：为 harness install 命令添加交互式平台选择功能，支持 codex / qoder / cc 三端配置管理，包括备份、恢复和同步机制。
- **chg-04** chg-04-slash-command修复
- **chg-05** chg-05-灵活问题捕获
- **chg-06** chg-06-workflow目录重命名
